; TEMPLATE KONFIGURASI OJS
; Salin menjadi config.inc.php saat deployment.
; Ganti domain, password, dan seluruh nilai GENERATE_NEW.
; Jangan commit config.inc.php asli ke Git.
...
host = db
username = ojs
password = "CHANGE_ME_MATCH_MARIADB_PASSWORD"
name = db_jurnal
...
salt = "GENERATE_NEW_RANDOM_SALT"

; The unique secret used for encoding and decoding API keys
api_key_secret = "GENERATE_NEW_API_KEY_SECRET"
...
repository_id = "ojs2.journal.example.org"
